...
const AsideDefault: FC = () => {
  ...
  return (
    <div
      ...
      ref={asideRef}
      style={{backgroundColor: '#2b276b'}}
    >
      {/* begin::Brand */}
      <div className='aside-logo flex-column-auto' id='kt_aside_logo' style={{backgroundColor: '#2b276b'}}>
        {/* begin::Logo */}
        {aside.theme === 'dark' && (
          <Link to='/dashboard'>
      ...
      <div className='aside-footer flex-column-auto pt-5 pb-7 px-5' id='kt_aside_footer'>
        ...
        >
          <span className='btn-label'  style={{color: 'whitesmoke'}}>Settings</span>
