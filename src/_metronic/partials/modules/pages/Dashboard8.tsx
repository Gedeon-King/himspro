...
const Dashboard8: React.FC<Props> = ({className}) => {
    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1'>2022 Monthly Claim</span>

          {/* <span className='text-muted fw-semibold fs-7'>Monthly Claim</span> */}
        </h3>
      </div>
      {/* end::Header */}
